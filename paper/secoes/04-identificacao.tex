...
de adoção dentro do estado: a máquina de diferenças-em-diferenças escalonado
\citep{callaway2021multiple,goodmanbacon2021,dechaisemartin2020} não se aplica a
este evento. A identificação vem de outra fonte de variação --- a
...
O estimador é o de \citet{callaway2024continuous}, para tratamento contínuo.
...
dose. A §\ref{sub:bans} o faz: a lei existiu e foi revogada seis meses depois,
e a ameaça não alcança a janela do estudo.
...
\begin{enumerate}
  ...
  \item \emph{wild cluster bootstrap} com pesos de Rademacher e nulo imposto
    \citep{cameron2008wild} --- com a ressalva de que ele sub-rejeita quando os
    clusters tratados são poucos, de modo que um valor-p alto informa mas um
    valor-p baixo não absolve \citep{canay2021wild};
...
mudanças de política --- \citet{conley2011} --- foi construído para tratamento
