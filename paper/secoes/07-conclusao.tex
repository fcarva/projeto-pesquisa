...
do \emph{custo} é calibrável de fonte secundária --- custo de aplicação aérea
contra terrestre por hectare, perda de rendimento na substituição --- e não
depende deste desenho. O lado do \emph{benefício} é que está vazio, e não se
resolve encorpando o grupo tratado na margem, porque o objeto que falta é uma
curvatura, e não um nível.
