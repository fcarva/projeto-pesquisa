...
> | **SEMACE / ANAC / MAPA** | ⚠️ o **SIPEAGRO** é dado aberto, mas começa em 2021. 🆕 **2026-09-23:** a IN MAPA nº 2/2008 (art. 14) obriga todo operador aeroagrícola a entregar **relatório mensal** à SFA do estado onde atuou — registro federal da aplicação aérea no pré-período, que o projeto nunca pediu. ⬜ **LAI ao MAPA a protocolar** (Fala.BR), depois de conferir o texto da IN: `docs/legislacao/lai-mapa-relatorios-mensais-minuta.md`; por quê em `docs/ars/18-medida-e-desenho-fase1-escopo.md`. A LAI à SEMACE continua valendo |
