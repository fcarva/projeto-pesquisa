...
> | **Bans municipais < 2019** | ✅ varridos — só Limoeiro do Norte (Lei 1.478, 20/11/2009), ⚠️⚠️ revogação **CONTESTADA em 2026-09-22**: o acervo COMPLETO da Câmara (2.692 leis) não tem a revogadora nem lei alguma datada de 20/05/2010. Ver `docs/legislacao/README.md` |
...
0. ✅ **Bans municipais anteriores — a lei de Limoeiro existiu, e foi REVOGADA (atualizado 2026-09-22).** Limoeiro do Norte proibiu a pulverização aérea pela **Lei Municipal 1.478, de 20/11/2009** (fonte primária: `camaralimoeirodonorte.ce.gov.br/leis/549`), e o município está no grupo tratado (6º de 169 na banana). ⚠️ **Mas a lei foi revogada em 20/05/2010**, um mês após o assassinato de Zé Maria do Tomé (CPT 2014; MST 2019 — **fontes secundárias**). ⚠️⚠️ **E em 2026-09-22 a revogação foi CONTESTADA:** a lei revogadora foi procurada no acervo **completo** da Câmara (`/leis/export`, 2.692 leis de 1987 a 2026) e **não existe** — nenhuma lei cita a 1.478, nenhuma outra toca o tema, e **não há lei datada de 20/05/2010** (as vizinhas são 12/05 e 21/05; 2010 está integralmente coberto). Não prova que a revogação não ocorreu — o acervo lista ementas e só leis, não decretos —, mas tudo que segue abaixo depende de um fato que agora falha na fonte primária. ⬜ **Decisão do pesquisador com o orientador.** Ver `docs/legislacao/README.md`. Na janela 2015–2018 Limoeiro **não** estava sob ban: a contaminação do pré-período é nula, e Limoeiro volta ao grupo genuinamente tratado. A varredura dos 17 tratados está completa (1 com lei, 16 `ausente_conferido`), mas ⚠️ ela grava só a PRIMEIRA lei achada e não procura revogação: todo `confirmado` exige conferência manual, registrada em `data_revogacao` (`docs/legislacao/bans-municipais-ce.csv`). Ver `docs/ars/16-diluicao-corolario1-limoeiro-calibracao.md` §5.
