...
| **Censo Demográfico 2022 — domicílios por setor** | CE + RN, 351 municípios (agregado de 468 mil setores) | ✅ **2026-09-22** | `15_censo_demografico.py` via **censobr** (IPEA), release `v1.0.0`, GitHub Releases — ⚠️ passa pelo proxy da sessão remota quando SIDRA/DATASUS não passam. 17 códigos conferidos contra o dicionário oficial (`2022_dictionary_tracts.xlsx`); fechamento 99,2% (água) e 99,1% (esgoto) | `data/raw/censobr/2022_tracts_domicilio_v1.0.0.parquet`; `data/processed/censo2022_domicilios_muni__uf23-24.parquet` |
